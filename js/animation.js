...
const config = {
    name: "I", // actual name of the recipient (Mandatory)

    nickname: "Manushi Patel", // nickname(optional)

    pic: "G", //image url of recipients (Mandatory)
...
button.addEventListener("click",function(){
    ...
    if(button.classList.contains("switch")) {
        ...
        */
        ...
        document.querySelector(".HBD").textContent = "Happy Birthday ❤️";
